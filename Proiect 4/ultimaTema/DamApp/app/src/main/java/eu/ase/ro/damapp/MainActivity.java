...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            openFragment();
            navView.setCheckedItem(R.id.calea_gabriela_nav_home);
        }
...
//            });
    ...
    private NavigationView.OnNavigationItemSelectedListener getItemSelected() {
        return item -> {
            if (item.getItemId() == R.id.calea_gabriela_nav_home) {
                currentFragment = HomeFragment.getInstance(expenses);
            } else if (item.getItemId() == R.id.calea_gabriela_nav_profile) {
                currentFragment = new ProfileFragment();
            } else if (item.getItemId() == R.id.calea_gabriela_nav_about) {
                currentFragment = new AboutFragment();
            } else if (item.getItemId() == R.id.calea_gabriela_nav_review) {
